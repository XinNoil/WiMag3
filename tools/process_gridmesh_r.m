function [cdns,magnetics,rssis,bssid_maps,bssid_indexs,types]=process_gridmesh_r(paths,gridmesh,mag_cols,bssid_map,origin,head,tail)
...
%         disp(['Rqs: ' n2s(cdns(c,1)) ' ' n2s(cdns(c,2)) ' ' num2str(folderList(I)) '/S' num2str(J) '.txt ' num2str(I-1) '/W' num2str(J) '.txt']);
        % 地磁
